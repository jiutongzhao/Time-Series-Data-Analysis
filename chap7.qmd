...
- The white outline is the **99 % significance contour**: the wavelet power exceeding the $\chi^2_2$ confidence level of an **AR(1) red-noise** background (Torrence & Compo). The chirp clears it comfortably in both detectors; almost nothing in the surrounding noise does.
...
for ax, raw, cmap, wcol, label in [(axH, H1, cmap_H, '#ff9a2e', 'LIGO Hanford'),
    ...
    sig99 = cal * Pbg * scipy.stats.chi2(2).ppf(0.99) / 2       # 99 % level: chi2_2(0.99)/2 = 4.605
    R = gaussian_filter(Pw, sigma=(1.6, 22.0)) / sig99[:, None]
