...
This is the 2-D radial power spectrum of a top-hat aperture, computed via the zeroth-order Hankel transform. The figure below shows the 2-D intensity distribution on the focal plane (left) alongside the radial cross-section (right), consistent with experimental photographs of stellar Airy disks in astronomy.
