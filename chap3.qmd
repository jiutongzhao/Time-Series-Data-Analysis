...
def shaded_sphere(l, m, tilt=-58, azim=18, npix=620, light=(-0.45, 0.6, 0.78)):
    ...
    rgb = rgb*(0.40 + 0.60*diff)[..., None] + (diff**22*0.18)[..., None]
...
fig.text(0.5, 0.865, 'blue $-$   white $0$   red $+$    ·    matching modes reinforce, mismatched ones cancel',
         ha='center', va='top', fontsize=8.8, color='#888888')
