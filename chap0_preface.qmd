...
<p align = 'center'><img src="docs/Figure/figure_fft_time_frequency.png" width="100%"/></p>
...
<p align = 'center'><img src="docs/Figure/figure_hearing_mechanism.jpg" width="100%"/></p>
<center><i> [Adopt from https://www.entlecture.com/physiology-of-hearing/]</i></center>


<!-- TODO: drop sound_frequency.mp4 into docs/Data/ before re-rendering. -->
::: {.callout-note}
The companion video `sound_frequency.mp4` is not yet committed to the
repo. Add it to `docs/Data/` and the embed below will appear.
:::

<!-- <video src="docs/Data/sound_frequency.mp4" width="100%" controls></video> -->`
...
## Indian Cuckoo
<p align = 'center'><img src="docs/Figure/figure_indian_cuckoo_with_bird.png" width="100%"/></p>
<p align = 'center'><audio id="audio" controls="" preload="none">
  <source id="mp3" src="docs/Data/indian_cuckoo_short.wav">
</audio></p>
<p align = 'center'><i>(Above): The Time Series of the Voice of Indian Cuckoo; (Bottom) Its Time-Frequency Spectrogram.</i></p>

## Sunspot Number
<img src="docs/Figure/figure_sunspot.png" width="100%"/>
<p align='center'><i>(Above): The Time Series of a Sunspot number; (Bottom) Its Frequency Spectrogram.</i></p>

## AO-Baltic Coherence
<img src="docs/Figure/figure_ao_baltic_truncated.png" width="100%"/>
<p align='center'><i>(Above): The Time Series of the Arctic Oscillation and Baltic indices; (Bottom) Their Coherence Spectrogram.</i></p>

## Mode Decomposition
<img src="docs/Figure/figure_seismic_waves.png" width="100%"/>
<p align='center'><i>(Above): A seismic waveform; (Bottom) Its decomposition into oscillation modes.</i></p>

## Chorus Wave SVD Analysis
<p align='center'><img src="docs/Figure/figure_svd_erg.png" width="100%"/></p>
<p align='center'><i>SVD-based wave analysis of magnetospheric chorus waves observed by ERG / Arase.</i></p>
