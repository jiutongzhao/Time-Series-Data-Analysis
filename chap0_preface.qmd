...
<!-- TODO: drop sound_frequency.mp4 into Data/ before re-rendering. -->
::: {.callout-note}
The companion video `sound_frequency.mp4` is not yet committed to the
repo. Add it to `Data/` and the embed below will appear.
:::

<!-- <video src="Data/sound_frequency.mp4" width="100%" controls></video> -->`
...
## Sunspot Number
<img src="Figure/figure_sunspot.png" width="100%"/>
<p align='center'><i>(Above): The Time Series of a Sunspot number; (Bottom) Its Frequency Spectrogram.</i></p>

## AO-Baltic Coherence
<img src="Figure/figure_ao_baltic_truncated.png" width="100%"/>
...
<p align='center'><img src="Figure/figure_svd_erg.png" width="100%"/></p>
